...
var resolve = {
  alias: {
    ...
    'howler-spatial$': path.resolve(
      __dirname,
      'node_modules/howler/dist/howler.spatial.min',
    ),
    ...
    'DE.BaseRenderer$': path.resolve(
      __dirname,
      'src/classes/renderer/BaseRenderer',
    ),
    'DE.TextureRenderer$': path.resolve(
      __dirname,
      'src/classes/renderer/TextureRenderer',
    ),
    'DE.SpriteRenderer$': path.resolve(
      __dirname,
      'src/classes/renderer/SpriteRenderer',
    ),
    'DE.TilingRenderer$': path.resolve(
      __dirname,
      'src/classes/renderer/TilingRenderer',
    ),
    'DE.TextRenderer$': path.resolve(
      __dirname,
      'src/classes/renderer/TextRenderer',
    ),
    'DE.GraphicRenderer$': path.resolve(
      __dirname,
      'src/classes/renderer/GraphicRenderer',
    ),
    'DE.RectRenderer$': path.resolve(
      __dirname,
      'src/classes/renderer/RectRenderer',
    ),

    'DE.GameObject$': path.resolve(
      __dirname,
      'src/classes/GameObject/GameObject',
    ),
    'DE.GameObject.automatisms$': path.resolve(
      __dirname,
      'src/classes/GameObject/GameObject.automatisms',
    ),
    'DE.GameObject.fade$': path.resolve(
      __dirname,
      'src/classes/GameObject/GameObject.fade',
    ),
    'DE.GameObject.focus$': path.resolve(
      __dirname,
      'src/classes/GameObject/GameObject.focus',
    ),
    'DE.GameObject.moveTo$': path.resolve(
      __dirname,
      'src/classes/GameObject/GameObject.moveTo',
    ),
    'DE.GameObject.scale$': path.resolve(
      __dirname,
      'src/classes/GameObject/GameObject.scale',
    ),
    'DE.GameObject.shake$': path.resolve(
      __dirname,
      'src/classes/GameObject/GameObject.shake',
    ),
    'DE.GameObject.update$': path.resolve(
      __dirname,
      'src/classes/GameObject/GameObject.update',
    ),
  },
};
