...
var Notifications = new (function () {
  ...
  this.init = function (params) {
    ...
    this.closeAnimationDuration =
      params.closeAnimationDuration || this.closeAnimationDuration;
    this.notificationClassName =
      params.notificationClassName || this.notificationClassName;
    ...
    this.template =
      params.template || templateContainer ? templateContainer.innerHTML : null;

    if (!this.container || !this.template) {
      throw new Error(
        "Can't init Notifications without a container element AND a template -- " +
          'container selector:: ' +
          this.selector +
          ' -- templateName:: ' +
          this.templateName,
