...
function Render(id, params) {
   ...
   * @memberOf Render
   */
  this._savedSizes = new PIXI.Point(
    _params.width || 100,
    _params.height || 100,
  );
  ...
  this.debugRender = new PIXI.Text(
    'DEBUG Enable \nDeltaTime: 1\nFPS: 60',
    new PIXI.TextStyle({
      fill: 'white',
      fontSize: 14,
...
Render.prototype._onResize = function () {
  ...
  var divParentH = window
    .getComputedStyle(this.div.parentElement, null)
    .getPropertyValue('height');
  if (
    this.div.parentElement != null &&
    divParentH &&
    screenH < document.body.clientHeight
  ) {
    var divW =
      this.div.parentElement.innerWidth || this.div.parentElement.clientWidth;
    var divH =
      this.div.parentElement.innerHeight || this.div.parentElement.clientHeight;
