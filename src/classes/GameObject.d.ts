...
declare class GameObject extends AdvancedContainer {
    ...
    constructor(params?: Partial<Omit<GameObject, 'scale'>> & {
        automatisms?: Array<Array<any>>;
        scale?: number | Point2D;
        scaleX?: number;
        scaleY?: number;
    });
    get automatisms(): Record<string, {
        0: string;
        1: Automatism;
    }>;
    /**
     ...
     * } );
     */
    addAutomatism(id: string, methodName?: string, params?: Partial<Automatism>): void;
    /**
